...
const MORE_PROJECTS = [
  ...
  },
  {
    id: 5,
    name: 'SKINSAVVY',
    desc: 'AI-powered Android app that analyzes skin health using machine learning. Bangkit Academy 2024 capstone.',
    tech: ['Kotlin', 'Android', 'TensorFlow Lite', 'Google Cloud'],
    link: 'https://github.com/SkinSavvy-DevTeam/SkinSavvy-Mobile',
    year: '2024',
